...
def main():
  ...
  plistpath = scriptpath + "/resources/NEL_VirtualControlSurface-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NEL_VirtualControlSurface-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NEL_VirtualControlSurface-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NEL_VirtualControlSurface-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/NEL_VirtualControlSurface-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/NEL_VirtualControlSurface.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/NEL_VirtualControlSurface.iss",inplace=1):
