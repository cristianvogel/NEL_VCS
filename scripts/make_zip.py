...
def  main():
  ...
  installer = "\installer\NEL_VirtualControlSurface Installer.exe"
   
  if demo:
    installer = "\installer\NEL_VirtualControlSurface Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\NEL_VirtualControlSurface manual.pdf" 
  ]
  ...
  ZIPNAME = "NEL_VirtualControlSurface-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "NEL_VirtualControlSurface-v" + FULLVERSIONSTR + "-win-demo.zip"
