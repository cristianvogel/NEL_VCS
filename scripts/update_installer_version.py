...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=NEL_VirtualControlSurface Demo Installer\n"
      else:
        line="OutputBaseFilename=NEL_VirtualControlSurface Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the NEL_VirtualControlSurface Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the NEL_VirtualControlSurface installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=NEL_VirtualControlSurface Demo installer\n"
     else:
       line="SetupWindowTitle=NEL_VirtualControlSurface installer\n"
